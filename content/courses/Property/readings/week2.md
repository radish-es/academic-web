...
<div class="comment"><details><summary><h4>Denial of Premise - Normative (Dickson)</h4></summary>

**The *Peters* case stands for the principle that shopping mall owners have sufficient possession of shopping mall sidewalks to exercise their right to exclude members of the public by bringing an action trespass against them.**

[(Jump to Laskin’s Argument)](#denial-of-premise-normative-laskin)</details></div>
...
<div class="comment"><details><summary><h4>Denial of Premise - Factual (Dickson)</h4></summary>

**There is no basis for distinguishing this case from *Peters* on the facts. Both cases were about peaceful picketing within a shopping centre in connection with a labour dispute. Therefore the Court here should apply the principle from *Peters* and arrive at the same result.**

[(Jump to Laskin’s Argument)](#denial-of-premise-factual-laskin)</details></div>
...
<div class="comment"><details><summary><h4>Counter-Theory (Dickson)</h4></summary>

**Attempts to balance competing interests—here, the commercial interests of the mall owner and the interests of the picketers in exercising the power of collective action in labour disputes—are the proper domain of elected legislatures rather than the courts, which are bound by the principle of *stare decisis* (past cases are binding).**

[(Jump to Laskin’s Argument)](#counter-theory-laskin)</details></div>
...
<div class="comment"><details><summary><h4>Symmetric Opposition (Dickson)</h4></summary>

**Property owners have a fundamental right to enjoyment of their property.**

[(Jump to Laskin’s Argument)](#symmetric—opposition-laskin)</details></div>

<div class="comment"><details><summary><h4>Mediation (Dickson)</h4></summary>

**The *Petty Trespasses Act* gives property owners the right to exclude any member of the public for any reason by bringing an action in trespass against them.**

[(Jump to Laskin’s Argument)](#mediation-laskin)</details></div>
...
<div class="comment"><details><summary><h4>Denial of Premise - Factual (Laskin)</h4></summary>

***Peters* can be distinguished from this case on the facts because here the defendant, Sophie Carswell, was engaged in a lawful strike protected by labour relations legislation, whereas in *Peters* the defendant was engaged in a boycott of goods sold by a store in the mall.**

[(Jump to Dickson’s Argument)](#denial-of-premise-factual-dickson)</details></div>
...
<div class="comment"><details><summary><h4>Denial of Premise - Normative (Laskin)</h4></summary>

***Peters* does not stand for the principle that shopping mall owners have sufficient possession of shopping mall sidewalks in all circumstances to exclude members of the public without a good reason to do so.**

[(Jump to Dickson’s Argument)](#denial-of-premise-normative-dickson)</details></div>
...
<div class="comment"><details><summary><h4>Counter-Theory (Laskin)</h4></summary>

**Courts should not pay “mechanical deference” to *stare decisis*, but rather have an obligation to respond to “new social facts” as they emerge by adapting the law to meet them.** 

[(Jump to Dickson’s Argument)](#counter-theory-dickson)</details></div>
...
<div class="comment"><details><summary><h4>Symmetric Opposition (Laskin)</h4></summary>

**Members of the public have fundamental rights (such as labour rights) that require access to public spaces for their lawful exercise.**

[(Jump to Dickson’s Argument)](#symmetric-opposition-dickson)</details></div>
...
<div class="comment"><details><summary><h4>Mediation (Laskin)</h4></summary>

**Members of the public enjoy a privilege of access to areas of property normally treated as public—a privilege which property owners have the power to revoke (by bringing an action under the *Petty Trespasses Act*) only if a member of the public is engaged in bad behaviour.**

[(Jump to Dickson’s Argument)](#mediation-dickson)</details></div>
